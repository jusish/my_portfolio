...
export const metadata: Metadata = {
  title: "About | Justin - Fullstack Developer",
  description:
    "Learn more about Justin, a Fullstack web developer specializing in React, Next.js, TypeScript, and modern web technologies.",
  keywords: [
    "About Justin",
    "Fullstack Developer",
    "React Developer",
