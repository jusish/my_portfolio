...
export const metadata: Metadata = {
  title: "Contact | Justin - Fullstack Developer",
  description:
    "Get in touch with Justin for web development projects, collaborations, and job opportunities.",
  keywords: [
    "Contact Justin",
        ...
        <div className="flex flex-col-reverse lg:flex-row items-center justify-between mt-8 gap-10">
          ...
          <div className="text-center lg:text-left md:w-1/2 lg:w-1/2 p-5">
            ...
            >
              ...
              <p className="text-[18px] text-gray-600">+250787415913</p>
            </Link>
          </div>
